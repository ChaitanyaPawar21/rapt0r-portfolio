// src/components/certification/frontend.js
...
const Frontend = () => {
  ...
  const certifications = [
    { 
      ...
      pdf: '/assets/certificates/react.jpg'
    },
    /*{ 
      src: '/assets/bikes/bike-white.png', 
      alt: 'Frontend Certification 2',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className={`text-lg ${theme.textSecondary} mb-2`}>
            Full-stack, React & Next.js, Tailwind CSS
          </p>
          <div className={`${theme.border} border-t pt-4 mt-4`}>
            <p className={`text-sm ${theme.textSecondary}`}>
              Explore my frontend development certifications and achievements.
            </p>
          </div>
        </div>
