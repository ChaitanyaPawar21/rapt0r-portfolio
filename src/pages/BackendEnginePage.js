// src/pages/BackendEnginePage.js
import React from 'react';
import { useNavigate } from 'react-router-dom';
import { ArrowLeft } from 'lucide-react';
import { useTheme } from '../components/ThemeContext';

const BackendEnginePage = () => {
  const navigate = useNavigate();
  const { theme } = useTheme();

  // Placeholder images - replace with your actual images
  const images = [
    { src: '/assets/bikes/bike-black.png', alt: 'Backend Project 1' },
    { src: '/assets/bikes/bike-white.png', alt: 'Backend Project 2' },
    { src: '/assets/bikes/ktm1390.png', alt: 'Backend Project 3' },
    { src: '/assets/bikes/black.png', alt: 'Backend Project 4' },
  ];
...
export default BackendEnginePage;
