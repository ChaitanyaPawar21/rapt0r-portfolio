// src/pages/DataStructuresPage.js
...
const DataStructuresPage = () => {
  ...
  const images = [
    { src: '/assets/bikes/bike-black.png', alt: 'DSA Project 1' },
    { src: '/assets/bikes/bike-white.png', alt: 'DSA Project 2' },
    { src: '/assets/bikes/ktm1390.png', alt: 'DSA Project 3' },
    { src: '/assets/bikes/black.png', alt: 'DSA Project 4' },
  ];
