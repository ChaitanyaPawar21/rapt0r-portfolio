// src/pages/FrontendFairingPage.js
import React from 'react';
import { useNavigate } from 'react-router-dom';
import { ArrowLeft } from 'lucide-react';
import { useTheme } from '../components/ThemeContext';

const FrontendFairingPage = () => {
  const navigate = useNavigate();
  const { theme } = useTheme();

  // Placeholder images - replace with your actual images
  const images = [
    { src: './assets/bikes/bike-black.png', alt: 'Frontend Project 1' },
    { src: './assets/bikes/bike-white.png', alt: 'Frontend Project 2' },
    { src: './assets/bikes/ktm1390.png', alt: 'Frontend Project 3' },
    { src: './assets/bikes/black.png', alt: 'Frontend Project 4' },
  ];
    ...
    <div className={`${theme.bg} min-h-screen py-20 px-4`}>
      <div className="max-w-6xl mx-auto">
        ...
        <p className={`text-lg ${theme.textSecondary} mb-12`}>
          Full-stack, React & Next.js, Tailwind CSS, Framer Motion
        </p>
...
export default FrontendFairingPage;
